...
public class PassengerController {
	...
	@RequestMapping(value = "/passenger", method = RequestMethod.POST, produces = { MediaType.APPLICATION_XML_VALUE,
	...
	public ResponseEntity<?> createPassenger(@RequestParam("firstname") String firstName,
		...
		return ResponseEntity.ok()
				.contentType("true".equals(xml) ? MediaType.APPLICATION_XML : MediaType.APPLICATION_JSON)
				.body(createdPassenger);
	}

	@RequestMapping(value = "/passenger/{id}", method = RequestMethod.PUT, produces = { MediaType.APPLICATION_XML_VALUE,
			MediaType.APPLICATION_JSON_VALUE })
